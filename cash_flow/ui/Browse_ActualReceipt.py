...
class Browse_ActualReceipt(QWidget):
    def __init__(self, engine, return_method):
        ...
        self.label_name = QLabel("Fakts ieņēmumi")
        self.table = ATable()
        self.table.setModel(ActualReceiptModel(self.table, self.engine, label_amount))
...
class ActualReceiptModel(ATableModel):
