...
class Browse_PendingPayment(QWidget):
    def __init__(self, engine, return_method):
        ...
        self.label_name = QLabel("Sagaidāmie maksājumi")
        self.table = ATable()
        self.table.setModel(PendingPaymentModel(self.table, self.engine, label_amount))
...
class PendingPaymentModel(ATableModel):
