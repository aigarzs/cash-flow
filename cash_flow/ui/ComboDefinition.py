...
from PyQt6.QtWidgets import (
    QApplication, QComboBox, QTableView, QVBoxLayout, QWidget, QAbstractItemView, QHeaderView
)
...
class ComboDefinition(QComboBox):
    def __init__(self, engine, parent=None, allow_empty=False):
        ...
        self.display_model = QStringListModel([row[1] for row in self.data], self)
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.comboBox = ComboDefinition(create_engine_db(), self)
