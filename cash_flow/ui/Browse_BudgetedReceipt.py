...
class Browse_BudgetedReceipt(QWidget):
    def __init__(self, engine, return_method):
        ...
        self.label_name = QLabel("Budžeta ieņēmumi")
        self.table = ATable()
        self.table.setModel(BudgetedReceiptModel(self.table, self.engine, label_amount))
...
class BudgetedReceiptModel(ATableModel):
    ...
    def _do_requery(self):
        ...
        total = transactions["Summa BV"].sum()
