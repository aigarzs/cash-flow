...
class CustomersInvoicesUncleared(QWidget):
    def __init__(self, engine, parent=None):
        ...
        self.table = ATable()
        self.table.setModel(CustomersInvoicesUnclearedModel(self.table, self.engine))
...
class CustomersInvoicesUnclearedModel(ATableModel):
    ...
    def requery(self):
        ...
        stmt = select(Document.id,
            ...
            .order_by(Document.date_planned_clearing, Customer.name, Document.priority, Document.date_due, Document.id)
        ...
        with Session(self.engine) as session:
            ...
            self.DATA = pd.DataFrame(dataset, columns=["id", "Tips", "Numurs", "Klients", "Datums",
                                                       "Apm.termiņš", "Plānotais datums", "Summa", "Atlikusī summa",
