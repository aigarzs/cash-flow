...
class VendorsInvoicesCleared(QWidget):
    def __init__(self, engine, parent=None):
        ...
        label_date_cleared = QLabel("Apmaksas datums")
        ...
        filterbox.addWidget(label_date_cleared)
        ...
        self.table = ATable()
        self.table.setModel(VendorsInvoicesClearedModel(self.table, self.engine))
...
class VendorsInvoicesClearedModel(ATableModel):
    ...
    def requery(self):
        ...
        stmt = select(Document.id,
            ...
            .order_by(Document.date_cleared, Vendor.name, Document.date_due, Document.id)
        ...
        with Session(self.engine) as session:
            ...
            self.DATA = pd.DataFrame(dataset, columns=["id", "Tips", "Numurs", "Piegādātājs",
                                                       "Datums", "Apm.termiņš", "Apm.datums", "Summa", "Valūta",
                                                       "Prioritāte", "Piezīmes"])
