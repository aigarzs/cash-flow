...
class Browse_ActualPayment(QWidget):
    def __init__(self, engine, return_method):
        ...
        self.label_name = QLabel("Fakts maksājumi")
        self.table = ATable()
        self.table.setModel(ActualPaymentModel(self.table, self.engine, label_amount))
...
class ActualPaymentModel(ATableModel):
