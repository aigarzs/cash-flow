...
class CustomersCreditnotes(QWidget):
    def __init__(self, engine, parent=None):
        ...
        self.table = ATable()
        self.table.setModel(CustomersCreditnotesModel(self.table, self.engine))
...
class CustomersCreditnotesModel(ATableModel):
    ...
    def requery(self):
        ...
        stmt = select(Document.id,
            ...
            .join(DocType) \
            .join(Customer) \
            .where(Document.type_id == DocType.CREDITNOTE_CUSTOMER) \
        ...
        with Session(self.engine) as session:
            ...
            self.DATA = pd.DataFrame(dataset, columns=["id", "Tips", "Numurs", "Klients", "Datums", "Summa",
                                                       "Valūta"])
